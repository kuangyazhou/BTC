  ...
  <div class="account">
    ...
    <el-row :gutter="2">
      <el-col :span="24">
        ...
        <el-button size="mini">修改基础信息</el-button>
    ...
    <el-row :gutter="2">
      <el-col :span="22">
        <el-table :border="true" size="mini" :data="tableData" style="width: 100%">
    ...
    <el-dialog title="新增一级代理" :close-on-click-modal="true" :visible.sync="dialogVisible" width="50%" :before-close="handleClose">
      <!-- <div class="flex"> -->
      <!-- label-position="left" -->
      <el-form :inline="true" label-width="100px" ref="form" size="mini">
        <el-form-item label="一级代理帐号" prop="userName">
          <el-input v-model="form.userName" placeholder="" name="username"></el-input>
        </el-form-item>
        <el-form-item label="一级代理名称" prop="pwd">
          <el-input type="password" @keyup.enter="onSubmit" v-model="form.pwd" placeholder="" name="pwd"></el-input>
        </el-form-item>
        <el-form-item label="密码" :rules="[{ required: true, message: '密码不能为空'},]" prop="userName">
          <el-input v-model="form.userName" placeholder="" name="username"></el-input>
        </el-form-item>
        <el-form-item label="确认密码" prop="pwd">
          <el-input type="password" @keyup.enter="onSubmit" v-model="form.pwd" placeholder="" name="pwd"></el-input>
        </el-form-item>
        <el-form-item label="一级代理及下级占成总数" prop="userName">
          <el-input v-model="form.userName" placeholder="" name="username"></el-input>
        </el-form-item>
        <el-form-item label="信用额度" :rules="[{ required: true, message: '信用额度不能为空'},]" prop="pwd">
          <el-input type="password" @keyup.enter="onSubmit" v-model="form.pwd" placeholder="" name="pwd"></el-input>
        </el-form-item>
        <el-form-item label="手续费比例" prop="userName">
          <el-input v-model="form.userName" placeholder="" name="username"></el-input>
        </el-form-item>
      </el-form>
      <!-- <span>一级代理帐号</span>
